...
class Gallery extends React.Component {
  constructor(props) {
    ...
    this.state = {
      photos: [
        // blurred out photo placeholders till fetch completes
        {
          url:
            "https://i1.wp.com/angularscript.com/wp-content/uploads/2018/06/Progressively-Loading-Images-With-Blur-Effect-min.png?w=800&ssl=1.jpg"
        },
        {
          url:
            "https://i1.wp.com/angularscript.com/wp-content/uploads/2018/06/Progressively-Loading-Images-With-Blur-Effect-min.png?w=800&ssl=1.jpg"
  ...
  componentDidMount() {
    ...
    this.state.id =
      url[url.indexOf("rooms")] === undefined
        ? 0
        : url[url.indexOf("rooms") + 1];
    this.fetchPhotos();
  }
